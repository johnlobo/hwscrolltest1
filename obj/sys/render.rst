...
Hexadecimal [16-Bits]
                              ...
                              6 ;;
                              7 ;; INIT 
                              8 ;;  Initialize video mode
                              9 ;;
   29D7                      10 sys_render_init::
                             11        ;; Set video mode
   29D7 0E 00         [ 7]   12     ld c,#0
   29D9 CD CB 2C      [17]   13     call cpct_setVideoMode_asm
                             14     ;; Set palette
   29DC 21 95 21      [10]   15     ld hl, #_g_palette
   29DF 11 10 00      [10]   16     ld de, #16
   29E2 CD 3A 2B      [17]   17     call cpct_setPalette_asm
                             18     ;; Set Border
   29E5 21 10 14      [10]   19     ld hl,#border_colour
   29E8 CD 59 2B      [17]   20     call cpct_setPALColour_asm
                             21 
                             22     ;; Clean up the screen 
   29EB 11 00 C0      [10]   23     ld de, #CPCT_VMEM_START_ASM
   29EE 3E 00         [ 7]   24     ld a, #0x00
   29F0 01 A0 0F      [10]   25     ld bc, #4000
   29F3 CD E0 2C      [17]   26     call cpct_memset_asm
                             27 
                             28     ;; Set Tileset
   29F6 21 A5 21      [10]   29     ld hl, #_g_tileset
   29F9 CD 98 2C      [17]   30     call cpct_etm_setTileset2x4_asm
                             31         
                             32     ;; Redraw newly appearing column (either it is left or right)
                             33     ;; Set Parameters on the stack
   29FC 21 40 00      [10]   34     ld   hl, #_g_tilemap                ;; HL = pointer to the tilemap
   29FF E5            [11]   35     push hl                             ;; Push ptilemap to the stack
   2A00 21 00 C0      [10]   36     ld   hl, #0xc000                    ;; HL = Pointer to video memory location where tilemap is drawn
   2A03 E5            [11]   37     push hl                             ;; Push pvideomem to the stack
                             38     ;; Set Paramters on registers
   2A04 3E A0         [ 7]   39     ld    a, #MAP_WIDTH                 ;; A = map_width
   2A06 06 00         [ 7]   40     ld    b, #0                         ;; B = x tile-coordinate
   2A08 0E 00         [ 7]   41     ld    c, #0                         ;; C = y tile-coordinate
   2A0A 16 2E         [ 7]   42     ld    d, #MAP_HEIGHT                ;; H = height in tiles of the tile-box
   2A0C 1E 28         [ 7]   43     ld    e, #VIEWPORT_WIDTH            ;; L =  width in tiles of the tile-box
   2A0E CD 0C 2C      [17]   44     call  cpct_etm_drawTileBox2x4_asm   ;; Call the function
                             45 
   2A11 C9            [10]   46     ret
                             47 
                             48 ;;
                             49 ;; UPDATE
                             50 ;;  Renders an entity
                             51 ;; Input
                             52 ;;  IX: Entity to be rendered
                             53 ;;
   2A12                      54 sys_render_update::
                             55 ;;    ;; HL = Pointer to previous render location
                             56 ;;    ld e, e_prevptr(ix)
                             57 ;;    ld d, e_prevptr+1(ix)
                             58 ;;    ex de, hl
...
Hexadecimal [16-Bits]
                             ...
                             59 ;;    ;; Check previous render location (nullptr = no previous render location)
                             60 ;;    ld a, l
                             61 ;;    or h
                             62 ;;    jr z, _do_not_erase
                             63 ;;_erase_prev:
                             64 ;;    ld (hl),#0
                             65 ;;_do_not_erase:
                             66 ;;    ;; Check entity alive before drawing
                             67 ;;    ld a, e_type(ix)
                             68 ;;    and #e_type_dead
                             69 ;;    ret nz
                             70 ;;
                             71 ;;;; Calculate new location
                             72 ;;    ld de, #0xc000
                             73 ;;    ld c, e_x(ix)
                             74 ;;    ld b, e_y(ix)
                             75 ;;    call cpct_getScreenPtr_asm
                             76 ;;
                             77 ;;;; Draw pixel
                             78 ;;    ld a, e_color(ix)
                             79 ;;    ld (hl), a
                             80 ;;
                             81 ;;;; Save new location to previous (for later erasing)
                             82 ;;    ex de, hl
                             83 ;;    ld e_prevptr(ix), e
                             84 ;;    ld e_prevptr+1(ix), d
   2A12 C9            [10]   85     ret
