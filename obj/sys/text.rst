...
Hexadecimal [16-Bits]
                     ...
                     0009    33 FONT_HEIGHT = 9
                             ...
                             48 
   2780                      49 str_length::
   2780 06 00         [ 7]   50     ld b, #0
   2782                      51 str_length_loop:
   2782 7E            [ 7]   52     ld a, (hl)
   2783 B7            [ 4]   53     or a
   2784 28 04         [12]   54     jr z, str_length_exit
   2786 04            [ 4]   55     inc b
   2787 23            [ 6]   56     inc hl
   2788 18 F8         [12]   57     jr str_length_loop
   278A                      58 str_length_exit:
   278A 78            [ 4]   59     ld a, b
   278B C9            [10]   60     ret
                             61 
                             62 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             74 
   278C                      75 str_copy::
   278C 22 93 27      [16]   76     ld (str_copy_savehl), hl    ;; [3] | Save HL before modifying them
   278F CD 80 27      [17]   77     call str_length
                     0013    78 str_copy_savehl = .+1           ;; Constant to retrive HL value
   2792 21 00 00      [10]   79     ld hl, #0000                ;; 0000 is a place holder for the original HL value
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   2795 06 00         [ 7]   80     ld b, #0                    ;; Store string length in BC
   2797 4F            [ 4]   81     ld c, a
   2798 ED B0         [21]   82     ldir                        ;; Copy from HL to DE
   279A C9            [10]   83     ret
                             84 
                             85 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             86 ;; str_cmp
                             ...
                             98 
   279B                      99 str_cmp::
   279B 7E            [ 7]  100     ld a, (hl)
   279C B7            [ 4]  101     or a
   279D 28 0D         [12]  102     jr z, str_cmp_check_last_pair
   279F F5            [11]  103     push af
   27A0 1A            [ 7]  104     ld a, (de)
   27A1 B7            [ 4]  105     or a
   27A2 28 0F         [12]  106     jr z, str_cmp_exit_false
   27A4 C1            [10]  107     pop bc
   27A5 B8            [ 4]  108     cp b
   27A6 20 0B         [12]  109     jr nz, str_cmp_exit_false
   27A8 23            [ 6]  110     inc hl
   27A9 13            [ 6]  111     inc de
   27AA 18 EF         [12]  112     jr str_cmp 
   27AC                     113 str_cmp_check_last_pair:
   27AC 1A            [ 7]  114     ld a, (de)
   27AD B7            [ 4]  115     or a
   27AE 20 03         [12]  116     jr nz, str_cmp_exit_false
   27B0                     117 str_cmp_exit_true:
   27B0 3E 01         [ 7]  118     ld a, #1
   27B2 C9            [10]  119     ret
   27B3                     120 str_cmp_exit_false:
   27B3 AF            [ 4]  121     xor a
   27B4 C9            [10]  122     ret
                            123 
                            124 
