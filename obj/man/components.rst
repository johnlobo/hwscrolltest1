...
Hexadecimal [16-Bits]
                              ...
                              1 ;;=============================================================================
                              2 ;; COMPONENT ENTITY POINTER MANAGER
                              3 ;;=============================================================================
                              4 
                              5 .module component_entity_ptr_manager
                              6 
...
Hexadecimal [16-Bits]
                             ...
                             75 ;; Entity offsets
                             76 ;;
   295C                      77 DefOffset 1, e_cmp_type
...
Hexadecimal [16-Bits]
                             ...
                             10 .include "cmp/array_structure.h.s"
                              1 ;;=============================================================================
...
Hexadecimal [16-Bits]
                             ...
                             12 
                             13 ;;=============================================================================
                             14 ;; Manager Member Variables
                             15 ;;=============================================================================
                             16 
   0000                      17 DefineComponentPointersTable _entities,  e_cmpID_Num_Components, max_entities
   0000                       1  	_entities_access_table:
                              2     .rept e_cmpID_Num_Components
                              3         .dw _entities_components + _CPT_off
                              4         _CPT_off = _CPT_off + _CPT_size
                              5     .endm
   295C 62 29                 1         .dw _entities_components + _CPT_off
                     0016     2         _CPT_off = _CPT_off + _CPT_size
   295E 78 29                 1         .dw _entities_components + _CPT_off
                     002C     2         _CPT_off = _CPT_off + _CPT_size
   2960 8E 29                 1         .dw _entities_components + _CPT_off
                     0042     2         _CPT_off = _CPT_off + _CPT_size
   2962                       6     _entities_components:
                              7     .rept e_cmpID_Num_Components
                              8         ;; Pend
                              9         .dw 0x0000  
                             10         ;;Array
                             11         .rept max_entities 
                             12  		    .dw 0x0000
                             13  	    .endm
                             14     .endm
                              1         ;; Pend
   2962 00 00                 2         .dw 0x0000  
                              3         ;;Array
                              4         .rept max_entities 
                              5  		    .dw 0x0000
                              6  	    .endm
   2964 00 00                 1  		    .dw 0x0000
   2966 00 00                 1  		    .dw 0x0000
   2968 00 00                 1  		    .dw 0x0000
   296A 00 00                 1  		    .dw 0x0000
   296C 00 00                 1  		    .dw 0x0000
   296E 00 00                 1  		    .dw 0x0000
   2970 00 00                 1  		    .dw 0x0000
   2972 00 00                 1  		    .dw 0x0000
   2974 00 00                 1  		    .dw 0x0000
   2976 00 00                 1  		    .dw 0x0000
                              1         ;; Pend
   2978 00 00                 2         .dw 0x0000  
                              3         ;;Array
                              4         .rept max_entities 
                              5  		    .dw 0x0000
                              6  	    .endm
   297A 00 00                 1  		    .dw 0x0000
   297C 00 00                 1  		    .dw 0x0000
   297E 00 00                 1  		    .dw 0x0000
   2980 00 00                 1  		    .dw 0x0000
   2982 00 00                 1  		    .dw 0x0000
   2984 00 00                 1  		    .dw 0x0000
   2986 00 00                 1  		    .dw 0x0000
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



   2988 00 00                 1  		    .dw 0x0000
   298A 00 00                 1  		    .dw 0x0000
   298C 00 00                 1  		    .dw 0x0000
                              1         ;; Pend
   298E 00 00                 2         .dw 0x0000  
                              3         ;;Array
                              4         .rept max_entities 
                              5  		    .dw 0x0000
                              6  	    .endm
   2990 00 00                 1  		    .dw 0x0000
   2992 00 00                 1  		    .dw 0x0000
   2994 00 00                 1  		    .dw 0x0000
   2996 00 00                 1  		    .dw 0x0000
   2998 00 00                 1  		    .dw 0x0000
   299A 00 00                 1  		    .dw 0x0000
   299C 00 00                 1  		    .dw 0x0000
   299E 00 00                 1  		    .dw 0x0000
   29A0 00 00                 1  		    .dw 0x0000
   29A2 00 00                 1  		    .dw 0x0000
                     0042    18 _components_size = . - _entities_components
                             19 
                             20 ;;=============================================================================
                             21 ;; Manager Public Functions
                             22 ;;=============================================================================
                             23 
                             24 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             25 ;; FUNC: man_components_getComponentPtrHL
                             26 ;;     Loads HL with the address of the component strructure of pointers (including pend) 
                             27 ;; INPUT:
                             28 ;;      A: Camponent ID        
                             29 ;; DESTROYS: AF
                             30 ;; RETURNS:
                             31 ;;      HL Pointer to the start of the pointers array
                             32 ;;      a: number of entities created        
   29A4                      33 man_components_getComponentPtrHL::
   29A4 21 5C 29      [10]   34     ld hl, #_entities_access_table
   29A7 87            [ 4]   35     add a                           ;; Each pointer in the access table takes 2 bytes
   004C                      36     add_hl_a
   004C                       1    add_REGPAIR_a  h, l
                              1    ;; First Perform RH = E + A
   29A8 85            [ 4]    2    add l    ;; [1] A' = RL + A 
   29A9 6F            [ 4]    3    ld  l, a ;; [1] RL' = A' = RL + A. It might generate Carry that must be added to RH
                              4    
                              5    ;; Then Perform RH = RH + Carry 
   29AA 8C            [ 4]    6    adc h    ;; [1] A'' = A' + RH + Carry = RL + A + RH + Carry
   29AB 95            [ 4]    7    sub l    ;; [1] Remove RL'. A''' = A'' - RL' = RL + A + RH + Carry - (RL + A) = RH + Carry
   29AC 67            [ 4]    8    ld  h, a ;; [1] Save into RH (RH' = A''' = RH + Carry)
                             37 
                             38     ;; Get pointer to the component structure in HL
   29AD 7E            [ 7]   39     ld a, (hl)
   29AE 23            [ 6]   40     inc hl
   29AF 66            [ 7]   41     ld h, (hl)
   29B0 6F            [ 4]   42     ld l, a
                             43 
   29B1 C9            [10]   44     ret
...
Hexadecimal [16-Bits]
                             ...
                             45 
                             46 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             47 ;; FUNC: man_components_getArrayHL
                             48 ;;      Gets a pointer to the array of entities in HL 
                             49 ;; INPUT:
                             50 ;; DESTROYS: HL
                             51 ;; RETURN:
                             52 ;;      IX: pointer to the entity array
                             53 ;;      a: number of entities created        
   29B2                      54 man_components_getArrayHL::
   29B2 CD A4 29      [17]   55     call man_components_getComponentPtrHL
   29B5 23            [ 6]   56     inc hl
   29B6 23            [ 6]   57     inc hl
   29B7 C9            [10]   58     ret
                             59 
                             60 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             61 ;; FUNC: man_components_init
                             62 ;;    
                             63 ;; INPUT:
                             64 ;; DESTROYS:
                             65 ;;    AF, BC, DE, HL
                             66 ;; RETURN:
                             67 ;;  HL: pointer to the start of the array
                             68 ;;
   29B8                      69 man_components_init::
                             70     ;;Set all values of the pointer array to nullptr
                             71     ;; filling in the array with zeroes
   29B8 21 62 29      [10]   72     ld hl, #_entities_components
   29BB 11 63 29      [10]   73     ld de, #_entities_components+1
   29BE 36 00         [10]   74     ld (hl), #0
   29C0 01 41 00      [10]   75     ld bc, #_components_size-1
   29C3 ED B0         [21]   76     ldir
                             77 
                             78     ;; set values for all Pend pointer in all pointer vectors
   29C5 06 03         [ 7]   79     ld b, #e_cmpID_Num_Components
   29C7                      80 _init_next_pend:
                             81     ;; Get in HL a pointer to the next component
   29C7 78            [ 4]   82     ld a, b
   29C8 3D            [ 4]   83     dec a
   29C9 CD A4 29      [17]   84     call man_components_getComponentPtrHL
                             85     ;; sets pend(HL location) with array address (HL + 2)
   29CC 5D            [ 4]   86     ld e, l
   29CD 54            [ 4]   87     ld d, h
   29CE 13            [ 6]   88     inc de
   29CF 13            [ 6]   89     inc de
   29D0 73            [ 7]   90     ld (hl), e
   29D1 23            [ 6]   91     inc hl
   29D2 72            [ 7]   92     ld (hl), d
   29D3 10 F2         [13]   93     djnz _init_next_pend
                             94 
   29D5 C9            [10]   95     ret
                             96 
                             97 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             98 ;; FUNC: man_components_init
                             99 ;;    
...
Hexadecimal [16-Bits]
                            ...
                            102 ;;    AF, BC, DE, HL
                            103 ;; RETURN:
                            104 ;;  HL: pointer to the start of the array
                            105 ;;
   29D6                     106 man_components_add::
   29D6 C9            [10]  107     ret
                            108 
