...
Hexadecimal [16-Bits]
                              ...
                              6 
                              7 ;; Include all CPCtelera constant definitions, macros and variables
...
Hexadecimal [16-Bits]
                              ...
                              9 .include "cmp/array_structure.h.s"
                              1 ;;=============================================================================
...
Hexadecimal [16-Bits]
                             ...
                             13 ;;.include "assets/assets.h.s"
                             14 
                             15 
                             16 ;;=================================================================
                             17 ;; Manager Memeber Variables
                             18 ;;=================================================================
                             19 
                             20 ;;-----------------------------------------------------------------
                             21 ;; Entity Components
   0000                      22 DefineComponentArrayStructure _entity, max_entities, DefineCmp_Entity_default
   2818 00                    1     _entity_num::    .db 0
   2819 1B 28                 2     _entity_pend::   .dw _entity_array
   281B                       3     _entity_array::
                              4     .rept max_entities
                              5         DefineCmp_Entity_default
                              6     .endm
   0003                       1         DefineCmp_Entity_default
   0003                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   281B 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   281C 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   281E 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
   2820 00 00                12         .dw nullptr
                             13         ;; CMP Render
   2822 FF 01                14         .db e_w_invalidEntity, 1      ;; size
   2824 00 00                15         .dw nullptr       ;; Sprite
   2826 CC CC                16         .dw 0xcccc      ;; current video memory pointer
   2828 CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   282A 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   282C 01                   20         .db 1        ;; AI-status (ai st)
   282D 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   282E 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   2830 01                   23         .db 1           ;; Moved flag
   2831 00                   24         .db 0x00
                             25      .endif
   001A                       1         DefineCmp_Entity_default
   001A                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   2832 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   2833 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   2835 00 00                10         .db 0, 0    ;; velocity
...
Hexadecimal [16-Bits]
                             ...
                             11         ;; CMP Animation
   2837 00 00                12         .dw nullptr
                             13         ;; CMP Render
   2839 FF 01                14         .db e_w_invalidEntity, 1      ;; size
   283B 00 00                15         .dw nullptr       ;; Sprite
   283D CC CC                16         .dw 0xcccc      ;; current video memory pointer
   283F CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   2841 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   2843 01                   20         .db 1        ;; AI-status (ai st)
   2844 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   2845 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   2847 01                   23         .db 1           ;; Moved flag
   2848 00                   24         .db 0x00
                             25      .endif
   0031                       1         DefineCmp_Entity_default
   0031                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   2849 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   284A 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   284C 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
   284E 00 00                12         .dw nullptr
                             13         ;; CMP Render
   2850 FF 01                14         .db e_w_invalidEntity, 1      ;; size
   2852 00 00                15         .dw nullptr       ;; Sprite
   2854 CC CC                16         .dw 0xcccc      ;; current video memory pointer
   2856 CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   2858 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   285A 01                   20         .db 1        ;; AI-status (ai st)
   285B 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   285C 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   285E 01                   23         .db 1           ;; Moved flag
   285F 00                   24         .db 0x00
                             25      .endif
   0048                       1         DefineCmp_Entity_default
   0048                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   2860 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   2861 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   2863 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
...
Hexadecimal [16-Bits]
   ...
   2865 00 00                12         .dw nullptr
                             13         ;; CMP Render
   2867 FF 01                14         .db e_w_invalidEntity, 1      ;; size
   2869 00 00                15         .dw nullptr       ;; Sprite
   286B CC CC                16         .dw 0xcccc      ;; current video memory pointer
   286D CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   286F 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   2871 01                   20         .db 1        ;; AI-status (ai st)
   2872 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   2873 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   2875 01                   23         .db 1           ;; Moved flag
   2876 00                   24         .db 0x00
                             25      .endif
   005F                       1         DefineCmp_Entity_default
   005F                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   2877 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   2878 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   287A 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
   287C 00 00                12         .dw nullptr
                             13         ;; CMP Render
   287E FF 01                14         .db e_w_invalidEntity, 1      ;; size
   2880 00 00                15         .dw nullptr       ;; Sprite
   2882 CC CC                16         .dw 0xcccc      ;; current video memory pointer
   2884 CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   2886 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   2888 01                   20         .db 1        ;; AI-status (ai st)
   2889 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   288A 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   288C 01                   23         .db 1           ;; Moved flag
   288D 00                   24         .db 0x00
                             25      .endif
   0076                       1         DefineCmp_Entity_default
   0076                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   288E 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   288F 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   2891 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
   2893 00 00                12         .dw nullptr
...
Hexadecimal [16-Bits]
                             ...
                             13         ;; CMP Render
   2895 FF 01                14         .db e_w_invalidEntity, 1      ;; size
   2897 00 00                15         .dw nullptr       ;; Sprite
   2899 CC CC                16         .dw 0xcccc      ;; current video memory pointer
   289B CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   289D 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   289F 01                   20         .db 1        ;; AI-status (ai st)
   28A0 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   28A1 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   28A3 01                   23         .db 1           ;; Moved flag
   28A4 00                   24         .db 0x00
                             25      .endif
   008D                       1         DefineCmp_Entity_default
   008D                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   28A5 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   28A6 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   28A8 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
   28AA 00 00                12         .dw nullptr
                             13         ;; CMP Render
   28AC FF 01                14         .db e_w_invalidEntity, 1      ;; size
   28AE 00 00                15         .dw nullptr       ;; Sprite
   28B0 CC CC                16         .dw 0xcccc      ;; current video memory pointer
   28B2 CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   28B4 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   28B6 01                   20         .db 1        ;; AI-status (ai st)
   28B7 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   28B8 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   28BA 01                   23         .db 1           ;; Moved flag
   28BB 00                   24         .db 0x00
                             25      .endif
   00A4                       1         DefineCmp_Entity_default
   00A4                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   28BC 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   28BD 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   28BF 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
   28C1 00 00                12         .dw nullptr
                             13         ;; CMP Render
...
Hexadecimal [16-Bits]
   ...
   28C3 FF 01                14         .db e_w_invalidEntity, 1      ;; size
   28C5 00 00                15         .dw nullptr       ;; Sprite
   28C7 CC CC                16         .dw 0xcccc      ;; current video memory pointer
   28C9 CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   28CB 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   28CD 01                   20         .db 1        ;; AI-status (ai st)
   28CE 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   28CF 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   28D1 01                   23         .db 1           ;; Moved flag
   28D2 00                   24         .db 0x00
                             25      .endif
   00BB                       1         DefineCmp_Entity_default
   00BB                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   28D3 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   28D4 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   28D6 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
   28D8 00 00                12         .dw nullptr
                             13         ;; CMP Render
   28DA FF 01                14         .db e_w_invalidEntity, 1      ;; size
   28DC 00 00                15         .dw nullptr       ;; Sprite
   28DE CC CC                16         .dw 0xcccc      ;; current video memory pointer
   28E0 CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   28E2 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   28E4 01                   20         .db 1        ;; AI-status (ai st)
   28E5 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   28E6 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   28E8 01                   23         .db 1           ;; Moved flag
   28E9 00                   24         .db 0x00
                             25      .endif
   00D2                       1         DefineCmp_Entity_default
   00D2                       1     DefineCmp_Entity  0,0,0,0, e_w_invalidEntity, 1, e_cmp_default, nullptr, nullptr, 1
                     000A     1     .narg __argn
                     0000     2     .if __argn - 10
                              3         .error 1
                     0001     4     .else
                              5         ;; Type of component
   28EA 0A                    6         .db e_cmp_default   ;; Types of components that the entity has
                              7         ;; CMP Position
   28EB 00 00                 8         .db 0, 0      ;; position
                              9         ;; CMP Velocity
   28ED 00 00                10         .db 0, 0    ;; velocity
                             11         ;; CMP Animation
   28EF 00 00                12         .dw nullptr
                             13         ;; CMP Render
   28F1 FF 01                14         .db e_w_invalidEntity, 1      ;; size
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 66.
Hexadecimal [16-Bits]



   28F3 00 00                15         .dw nullptr       ;; Sprite
   28F5 CC CC                16         .dw 0xcccc      ;; current video memory pointer
   28F7 CC CC                17         .dw 0xcccc      ;; last video memory pointer
                             18         ;; CMP AI
   28F9 00 00                19         .db 0x00, 0x00  ;; AI-aim (ai aim x, ai aim y)
   28FB 01                   20         .db 1        ;; AI-status (ai st)
   28FC 01                   21         .db 1        ;; AI-previous-status (ai pre st)
   28FD 00 00                22         .dw nullptr     ;; Next AI Patrol step (ai patrol step)
   28FF 01                   23         .db 1           ;; Moved flag
   2900 00                   24         .db 0x00
                             25      .endif
                             23 
                             24 
                             25 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             26 ;; FUNC: man_entity_getArrayHL
                             27 ;;      Gets a pointer to the array of entities in HL 
                             28 ;; INPUT:
                             29 ;; DESTROYS: HL
                             30 ;; RETURN:
                             31 ;;      IX: pointer to the entity array
                             32 ;;      a: number of entities created        
   2901                      33 man_entity_getArrayHL::
   2901 21 1B 28      [10]   34     ld hl, #_entity_array
   2904 C9            [10]   35     ret
                             36     
                             37 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             38 ;; FUNC: man_entity_init
                             39 ;;    
                             40 ;; INPUT:
                             41 ;; DESTROYS:
                             42 ;;    AF, HL
                             43 ;; RETURN:
                             44 ;;  HL: pointer to the start of the array
                             45 ;;
   2905                      46 man_entity_init::
                             47     ;; Init other subsidiary managers
   2905 CD B8 29      [17]   48     call man_components_init
                             49     ;; Reset all component vector values
   2908 AF            [ 4]   50     xor a
   2909 32 18 28      [13]   51     ld (_entity_num), a
                             52     
   290C 21 1B 28      [10]   53     ld hl, #_entity_array
   290F 22 19 28      [16]   54     ld (_entity_pend), hl
                             55     
                             56     ;; First entity must be marked as no entity as it is the last valid 
                             57     ;; entity of the array
   2912 EB            [ 4]   58     ex de,hl
   2913 21 07 00      [10]   59     ld hl, #e_w
   2916 19            [11]   60     add hl, de
   2917 36 FF         [10]   61     ld (hl), #e_w_invalidEntity
   2919 EB            [ 4]   62     ex de, hl
                             63     
   291A C9            [10]   64     ret
                             65  
                             66 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
                             ...
                             67 ;; FUNC: man_entity_new
                             68 ;;    
                             69 ;; INPUT:
                             70 ;;    HL: Pointer to the initilized values of the new entity to be created
                             71 ;; DESTROYS:
                             72 ;;    AF, BC, DE, HL
                             73 ;; RETURN:
                             74 ;;    DE pointer to the new entity
                             75 ;;    BC sizeof (Entity t)  
                             76 ;;
   291B                      77 man_entity_new::
                             78     ;; _entity_num++
   291B 21 18 28      [10]   79     ld hl, #_entity_num
   291E 34            [11]   80     inc (hl)
                             81     ;; Increment array pointer to point to the next free element of the array
   291F 2A 19 28      [16]   82     ld hl, (_entity_pend)
   2922 54            [ 4]   83     ld d, h
   2923 5D            [ 4]   84     ld e, l
   2924 01 17 00      [10]   85     ld bc, #sizeof_e
   2927 09            [11]   86     add hl,bc
   2928 22 19 28      [16]   87     ld (_entity_pend), hl
                             88     
   292B C9            [10]   89     ret
                             90 
                             91 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             92 ;; FUNC: man_entity_create
                             93 ;;    
                             94 ;; INPUT:
                             95 ;;    HL: Pointer to the initilized values of the new entity to be created
                             96 ;; DESTROYS:
                             97 ;;    AF, BC, DE, HL
                             98 ;; RETURN:
                             99 ;;    IX pointer to the component created
                            100 ;;
   292C                     101 man_entity_create::
                            102     ;; save hl value
   292C E5            [11]  103     push hl
   292D CD 1B 29      [17]  104     call man_entity_new
                            105     ;; IX = DE
   0118                     106     ld__ixh_d
   2930 DD 62                 1    .dw #0x62DD  ;; Opcode for ld ixh, d
   011A                     107     ld__ixl_e
   2932 DD 6B                 1    .dw #0x6BDD  ;; Opcode for ld ixl, e
                            108     ;;Copy initilization value to new entity
                            109     ;; DE points to the new added entity
                            110     ;; BC holds sizeof(Entity t)
   2934 E1            [10]  111     pop hl
                            112     ;; copy form hl to de, bc bytes (bc is returned by man_entity_new)
   2935 ED B0         [21]  113     ldir
                            114     
                            115     ;; Check for components to add the entity to
   2937 DD 7E 00      [19]  116     ld a, e_cmp_type(ix)
   293A E6 01         [ 7]  117     and #e_cmp_AI
   293C 28 05         [12]  118     jr z, _noAI
   293E                     119 _AI:
...
Hexadecimal [16-Bits]
   ...
   293E 3E 00         [ 7]  120     ld a, #e_cmpID_AI
   2940 CD D6 29      [17]  121     call man_components_add
   2943                     122 _noAI:
   2943 DD 7E 00      [19]  123     ld a, e_cmp_type(ix)
   2946 E6 02         [ 7]  124     and #e_cmp_Physics
   2948 28 05         [12]  125     jr z, _noPhys
   294A                     126 _Phys:
   294A 3E 01         [ 7]  127     ld a, #e_cmpID_Physics
   294C CD D6 29      [17]  128     call man_components_add
   294F                     129 _noPhys:
   294F DD 7E 00      [19]  130     ld a, e_cmp_type(ix)
   2952 E6 04         [ 7]  131     and #e_cmp_Animation
   2954 28 05         [12]  132     jr z, _noAnim
   2956                     133 _Anim:
   2956 3E 02         [ 7]  134     ld a, #e_cmpID_Animation
   2958 CD D6 29      [17]  135     call man_components_add
   295B                     136 _noAnim:
                            137 
                            138     
   295B C9            [10]  139     ret
